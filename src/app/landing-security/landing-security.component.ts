...
export class LandingSecurityComponent implements OnInit {
  ...
  regionList = {
    ...
    "Antioch": ["Bay Point", "Bethel Island", "Brentwood", "Byron", "Clayton", "Contra Costa Centre", "Discovery Bay", "Knightsen", "Oakley", "Pittsburg", "Shell Ridge"],
    ...
    "Walnut Creek": ["Acalanes Ridge", "Alamo", "Ashland", "Blackhawk", "Camino Tassajara", "Castro Valley", "Castle Hill", "Danville", "Diablo", "Dublin", "Fremont", "Hayward", "Livermore", "Moraga", "Newark", "Norris Canyon", "Pleasanton", "San Leandro", "San Lorenzo", "San Ramon", "Sunol", "Walnut Creek"],
