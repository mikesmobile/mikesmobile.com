...
const appRoutes: Routes = [
  { path: 'fireplace-manuals',  component: FireplaceManualsComponent, data: { title: "Fireplace Manuals | Mike's Mobile Chimney Service & Repair" }},
  { path: 'free-quote',         component: FreeQuoteComponent,        data: { title: "Free Quote | Mike's Mobile Screen and Chimney Service" }},
  { path: 'contract',           component: ContractComponent,         data: { title: "Our Countract | Mike's Mobile Screen and Chimney Service" }},
  ...
  { path: 'regions',            component: RegionListComponent,       data: { title: "Mike's Mobile Screen and Chimney Service" }},
  { path: '',                   component: HomeComponent,             data: { title: "Mike's Mobile Screen and Chimney Service" }, pathMatch: 'full'},
