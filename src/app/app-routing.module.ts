...
const appRoutes: Routes = [
  ...
  { path: 'free-quote',         component: FreeQuoteComponent,        data: { title: "Mike's Mobile Screen and Chimney Service" }},
  { path: 'contract',           component: ContractComponent,         data: { title: "Mike's Mobile Screen and Chimney Service" }},
